...
const AddPost = props => {
  const { gift, toggleGift, user, open } = props;
  ...
  const handleGift = async () => {
	...
	const renderTab = () => {
      ...
      >
        <Tab classes={tabItemStyles} disableRipple label={"Site"} />
        <Tab classes={tabItemStyles} disableRipple label={"Regular"} />
      </Tabs>
    );
	}
